...
import { AgentSignUpSchema } from "@/schemas/auth/AuthSchema";
...
const AgentSignUp = () => {
  ...
  const form = useForm<z.infer<typeof AgentSignUpSchema>>({
  ...
  function onSubmit(values: z.infer<typeof AgentSignUpSchema>) {
    console.log(values);
